    ...
    return (
        <>
            ...
            <section className="col-12 p-xl-3 py-3 p-2 my-5 banner-center d-flex  justify-content-center align-items-center">
                ...
                <h4 dir="rtl" className="d-block d-xl-none m-0 p-0 fw-bold text-light"><a href="https://elanza.com" target="_blank" className="text-decoration-none text-white fw-bold ">تخفیف های یلدایی الانزا</a></h4>
                <img src="img/barf.png" className="img-hendevaneh img4 d-none d-lg-block" alt=""/>
            </section>
